...
int detect(char *model_path, char *image_path, char *save_image_path)
{
    ...
    printf("model %d tiems run avg use %f ms\n", temp, (__get_us(stop_time) - __get_us(start_time)) / 1000 / temp);
    ...
    gettimeofday(&stop_time, NULL);
    printf("postprocess %d tiems run avg use %f ms\n", temp, (__get_us(stop_time) - __get_us(start_time)) / 1000 / temp);
    ...
    for (int i = 0; i < DetectiontRects.size(); i += 6)
    {
        ...
        putText(src_image, text1, cv::Point(xmin, ymin), cv::FONT_HERSHEY_SIMPLEX, 0.7, cv::Scalar(0, 0, 255), 2);
    }
...
{
    char model_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov11_06/model/RK3588/yolov11n.rknn";
    char image_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov11_06/test.jpg";
    char save_image_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov11_06/test_result.jpg";
